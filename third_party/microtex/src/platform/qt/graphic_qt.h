...
// Qt cannot draw several codepoints below 33: the wstring conversion above
// truncates at NUL and codes 9/10/12/13/32 shape as inkless whitespace. The
// generated NewTX fonts alias each TeX slot below 33 at U+E000+slot (see
// tools/build_newtx_outline_fonts.py); this remaps a glyph code to that alias
// when the generated prototype mode is active, and is a no-op otherwise.
wchar_t kvit_remap_generated_low_slot(wchar_t c);
