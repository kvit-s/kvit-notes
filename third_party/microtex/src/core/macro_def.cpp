...
#define mac mac3
    ...
    mac(1, macro_textstyles, "mathslscr"),
    mac(1, macro_textstyles, "mathuscr"),
    mac(1, macro_textstyles, "mathbb"),
    mac(1, macro_textstyles, "varmathbb"),
    mac(1, macro_textstyles, "vmathbb"),
    mac(1, macro_textstyles, "vvmathbb"),
    ...
    mac(1, macro_accents, "lvec"),
    mac(1, macro_accents, "lrvec"),
    mac(1, macro_accents, "harpoonacc"),
    mac(1, macro_accents, "lharpoonacc"),
    mac(1, macro_accents, "lrharpoonacc"),
    mac(1, macro_accents, "widearc"),
    mac(1, macro_accents, "wideOarc"),
    mac(1, macro_accents, "barbar"),
    mac(1, macro_accents, "bartilde"),
    mac(1, macro_accents, "barhat"),
    mac(1, macro_accents, "tildebar"),
    mac(1, macro_accents, "tildetilde"),
    mac(1, macro_accents, "tildehat"),
    mac(1, macro_accents, "hatbar"),
    mac(1, macro_accents, "hattilde"),
    mac(1, macro_accents, "hathat"),
    ...
    mac(1, macro_undergroup, "undergroup"),
    mac(1, macro_overgroup, "overgroup"),
    mac(1, macro_undergroupra, "undergroupra"),
    mac(1, macro_overgroupra, "overgroupra"),
    mac(1, macro_undergroupla, "undergroupla"),
    mac(1, macro_overgroupla, "overgroupla"),
    mac(1, macro_widering, "widering"),
    mac(1, macro_sqrt, "sqrtsign"),
    mac(1, macro_overline, "overline"),
    mac(1, macro_overline, "widebar"),
